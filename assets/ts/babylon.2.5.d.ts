declare module BABYLON {
    ...
    class Engine {
        ...
        createRawCubeTexture(url: string, scene: Scene, size: number, format: number, type: number, noMipmap: boolean, callback: (ArrayBuffer : any) => ArrayBufferView[], mipmmapGenerator: ((faces: ArrayBufferView[]) => ArrayBufferView[][])): WebGLTexture;
...
interface Window {
    ...
    CANNON: any;
    SIMD: any;
    AudioContext: AudioContextc;
    webkitAudioContext: AudioContextc;
    PointerEvent: any;
    Math: Math;
    Uint8Array: Uint8ArrayConstructor;
    Float32Array: Float32ArrayConstructor;
}
interface AudioContextc extends EventTarget {
...
declare module BABYLON {
    ...
    class Tools {
        ...
        static Vector2ArrayFeeder(array: Array<Vector2> | Float32Array): (i : any) => Vector2;
        ...
        static first<T>(array: Array<T>, predicate: (item : any) => boolean): T;
        /**
         ...
         * @param array
         */
        static arrayOrStringFeeder(array: any): (i : any) => number;
        /**
...
declare module BABYLON {
    ...
    class HDRCubeTexture extends BaseTexture {
         ...
         * @return The packed binary data.
         */
        static generateBabylonHDR(url: string, size: number, callback: ((ArrayBuffer : any) => void), onError?: (() => void)): void;
    }
}
...
declare module BABYLON {
    class RenderTargetTexture extends Texture {
        ...
        */
        renderListPredicate: (AbstractMesh : any) => boolean;
        /**
